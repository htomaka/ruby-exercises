...
class EnumerablesTest < Minitest::Test
  ...
  def test_pick_floats
    ...
    actual = numbers.select {|num| num.is_a? Float}
  ...
  def test_array_with_the_most_items
    ...
    actual = arrays.max_by {|array| array.length}
  ...
  def test_none_are_negative
    ...
    actual = numbers.none? {|num| num.negative?}
    assert true, actual
  end
  ...
  def test_sum_a_list_of_numbers
    ...
    actual = numbers.reduce(0) {|sum, num| sum += num}
  ...
  def test_most_programmers
    ...
    actual = programmers.max_by {|lang, names| names.length}
  ...
  def test_none_are_broken
    ...
    actual = things.none? {|word| word == "broken"}
    assert actual
  end
  ...
  def test_multiply_list_of_numbers
    numbers = [2, 3, 5, 7]
    actual = numbers.inject(1) {|product, num| product *= num}
  ...
  def test_sort_by_distance
    ...
    actual = distances.sort_by {|dist| dist.to_i}
  ...
  def test_remove_hashes
    ...
    actual = elements.reject {|el| el.is_a? Hash}
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    actual = keywords.inject('one fish two fish red fish blue fish') do |acc, el|
      acc.gsub(el, el.upcase)
    end
  ...
  def test_subtract_smallest_values_from_100
    ...
    actual = elements.reduce(100) {|diff, arr| diff -= arr.min}
  ...
  def test_group_by_number_of_zeros
    ...
    actual = numbers.group_by {|num| Math.log10(num).floor}
  ...
  def test_count_round_prices
    ...
    actual = prices.count {|price| (price % 1) == 0}
    assert_equal 2, actual
  end
