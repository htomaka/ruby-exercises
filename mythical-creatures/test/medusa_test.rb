...
class MedusaTest < Minitest::Test
  ...
  def test_can_only_have_three_victims
    medusa = Medusa.new("Cassiopeia")
    medusa.stare(Person.new("Perseus"))
    medusa.stare(Person.new("Polydectes"))
    medusa.stare(Person.new("Hermes"))
    medusa.stare(Person.new("Pegasus"))
  ...
  def test_if_a_fourth_victim_is_stoned_first_is_unstoned
    ...
    medusa.stare(Person.new("Polydectes"))
    medusa.stare(Person.new("Hermes"))
    fourth = Person.new("Pegasus")
    medusa.stare(fourth)
    
    refute first.stoned?
    assert fourth.stoned?
  end
